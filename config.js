...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/e8c60e26be85ad06015af.jpg'
module.exports = {
  ...
  author:  process.env.PACK_AUTHER ||  'Ascends,
  packname:  process.env.PACK_NAME || 'As-Legend',
